...
To validate system correctness, we conducted unit, integration, and end-to-end tests.

\begin{enumerate}
	\item \textbf{Unit.} We conducted tests using controlled inputs and expected outputs on individual functions.
	\item \textbf{Integration.} We conducted tests that exercised the full computational graph.
	\item \textbf{End-to-end.} We conducted end-to-end simulations of real user interactions through the UI.
\end{enumerate}

We iteratively improved our system to ensure all tests passed.

\section{System Evaluation}

To identify the most suitable model from our chosen candidate set of chat models, we defined an overall utility measure combining objective and subjective components.
...
PDPC22 contains twenty-two question-answer pairs from an educational quiz-like game by PDPC,
...
Then, we examined the properties of PDPC22 and APDPC22, using GPT-2 as a reference point because it is open-weights and widely used.
