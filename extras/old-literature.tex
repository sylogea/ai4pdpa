...
% The growing reliance on technologies and AI results in the need for a clear governance framework to manage the collection, use, and disposal of personal data responsibly \parencite{schubert2024}.
% As digital services expand across different industries, the risk of data misuse, unauthorised access and breaches has also grown \parencite{kpmg2023}.
...
To aid compliance, the PDPC uploads advisory guidelines to aid organisations and individuals in their understanding of the PDPA \parencite{pdpc2022}.

\section{Challenges}

Despite the availability of these resources, many organisations and individuals struggle to understand and comply with PDPA requirements correctly due to regulations which constantly evolve \parencite{ismart2024}.
...
% This suggests that as innovative technologies and regulations emerge, traditional resources may be insufficient for compliance support.
...
SMEs form the backbone of Singapore economy \parencite{lim2025}.
...
% Because SMEs must prioritise day-to-day operations and revenue generation, compliance is viewed as a secondary priority.
Hence, many do not allocate sufficient time, budget, or staff to interpret and implement compliance regulations \parencite{complianceconsultant2025}.
Digital capability gaps further worsen the compliance challenge. According to a survey conducted by Capterra, 32\% of SMEs still rely on spreadsheets to manage customer information, while another 35\% use manual methods or email communication, which are insufficient under modern data protection guidelines \parencite{navarrete2019}. These informal, decentralised data management methods make it difficult to track consent, accurately update records, and securely ensure retention and disposal.
...
% Hence, users often struggle to identify which specific sections apply to their situation or to interpret PDPA requirements without legal or technical expertise \parencite{lonzetta2020}.
...
However, they are costly, and they require ongoing subscription fees, which are impractical for SMEs with limited budgets.
For example, Onspring's privacy management software costs approximately \$30,000 to \$56,000 for initial setup with annual subscription fees ranging from \$10,000 to \$50,000 \parencite{randall2025}.
...
Natural language processing (NLP) and large language models (LLMs) allow systems to interpret, analyse, and generate human-like responses to text-based queries \parencite{vaniukov2024}.
...
Similarly, there is growing recognition that such tools can extend to the data protection and compliance domain. Developments in this area align with Smart Nation initiatives, which encourage the use of AI to improve governance, productivity, and security \parencite{govsg2023}.
...
LLMs generate outputs probabilistically and may produce inaccurate, misleading, or hallucinated information.
OpenAI publicly acknowledges this behaviour in its model documentation, noting that LLMs can generate plausible-sounding but incorrect statements \parencite{openai2023}
...
PDPC guidance emphasises that the handling of identifiers—such as NRIC numbers—involves heightened obligations due to the risks of identity theft and misuse if the data is retained or transmitted unnecessarily \parencite{pdpc2022}.
...
General-purpose AI models often incorporate patterns from global datasets, which can lead to inappropriate blending of regulatory concepts across jurisdictions.
...
Finally, AI chatbots can amplify misinformation risks. IBM’s research on trustworthy AI highlights that the natural language fluency of modern LLMs can obscure underlying inaccuracies, making hallucinations especially dangerous in high-stakes domains such as law, healthcare, and compliance \parencite{chen2023}.
...
Retrieval-augmented generation (RAG) is an increasingly important technique for improving the factual accuracy, grounding, and explainability of LLM-based systems.
...
In line with these requirements, the platform functions strictly as an informational tool and does not provide legal advice.
Privacy-by-design principles guide the system's architecture. User inputs are processed transiently, with no persistent server-side logging of identifiers.
...
Because LLMs may hallucinate or present overconfident but inaccurate responses, robust safety controls are essential.
...
Responsible AI literature also highlights techniques such as RAG, validated knowledge sources, rate limiting, and transparency prompts as effective mitigation strategies in safety-critical systems \parencite{deepmind2024}.
...
If future features---such as server-side chat history, organisational analytics, or multi-user administration---are introduced, additional safeguards will be required. These include encryption at rest, role-based access controls, access logging, and explicit retention and deletion policies to remain compliant with PDPA obligations \parencite{pdpc2022}.
Continuous monitoring of regulatory changes, emerging AI safety research, and system behaviour will be essential to ensure that new functionalities do not introduce unintended risks.
